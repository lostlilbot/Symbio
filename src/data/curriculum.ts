export type PillarId = "ai-mastery" | "human-edge" | "ethics-leadership" | "interdisciplinary";
export type GradeLevel = 9 | 10 | 11 | 12;
export type CourseLevel = "Foundation" | "Intermediate" | "Advanced" | "Capstone";
...
export const pillarMeta: Record<PillarId | "all", { id: PillarId | "all"; name: string; color: string; icon: string }> = {
  all: { id: "all", name: "All Pillars", color: "slate", icon: "all" },
  "ai-mastery": { id: "ai-mastery", name: "AI Mastery", color: "cyan", icon: "ai-mastery" },
  "human-edge": { id: "human-edge", name: "Human Edge", color: "emerald", icon: "human-edge" },
  "ethics-leadership": { id: "ethics-leadership", name: "Ethics & Leadership", color: "violet", icon: "ethics-leadership" },
  "interdisciplinary": { id: "interdisciplinary", name: "Interdisciplinary", color: "amber", icon: "interdisciplinary" },
};

export const levelStyles: Record<string, { bg: string; text: string; border: string }> = {
...
export const pillarFilterStyles: Record<PillarId | "all", { bg: string; text: string; border: string }> = {
